...
# use tab to cycle throught autocompletions
zstyle ':completion:*' matcher-list 'm:{a-z}={A-Z}' 'm:{A-Z}={a-z}' 'r:|[.]/=* r:|=*'
...
clear_prompt_input() {
  zle kill-whole-line  # Clears the entire input line
  zle reset-prompt     # Resets the prompt
}
zle -N clear_prompt_input
